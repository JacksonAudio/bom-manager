...
> Extracted from `https://stripe.com` on April 15, 2026
...
**Easing functions:** `cubic-bezier(0.45, 0.05, 0.55, 0.95)`, `cubic-bezier(0.25, 1, 0.5, 1)`, `cubic-bezier(0.4, 0, 0.2, 1)`, `cubic-bezier(0.6, 0, 0.2, 0.5)`, `ease`, `linear`, `cubic-bezier(0.165, 0.84, 0.44, 1)`, `cubic-bezier(0.16, 1, 0.3, 1)`, `cubic-bezier(0.33, 1, 0.68, 1)`, `cubic-bezier(0.65, 0, 0.35, 1)`, `cubic-bezier(0.3, 0, 0.2, 1)`
...
- 21 unique spacing values — too many one-off values
